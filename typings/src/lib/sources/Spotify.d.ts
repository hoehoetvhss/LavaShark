...
export default class Spotify extends AbstractExternalSource {
    ...
    private token;
    private renewDate;
    private partnerAppVersion;
    private partnerQueryHashes;
    ...
    private getPartnerTrack;
    private getPartnerPlaylist;
    private getPartnerAlbum;
    private getPartnerArtistTopTracks;
    private buildPartnerPlaylistResult;
    private buildPartnerTrack;
    private makePartnerRequest;
    private getPartnerQueryHash;
